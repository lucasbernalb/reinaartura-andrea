...
export default function PageLoader() {
  ...
  useEffect(() => {
    ...
    // Phase 3: Show full logo (2900-4200ms), then fade out loader
  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'linear-gradient(135deg, #1a1412 0%, #0a0808 60%, #231a16 100%)',
      }}
    >
      {/* Phase 1 & 2: Initials */}
      <div
          ...
          <div className="relative">
            ...
            >
              <svg width="28" height="20" viewBox="0 0 28 20">
                ...
                />
                <rect x="2" y="18" width="24" height="4" rx="1" fill="#C8A2C8" />
              </svg>
            </div>
          </div>
        </div>
      ...
      >
        ...
        {/* Decorative line */}
        <div
          className="mx-auto h-px bg-gradient-to-r from-transparent via-[#C8A2C8] to-transparent transition-all duration-800"
          style={{
        ...
        <div className="flex justify-center gap-1.5 mt-4">
          {[0, 0.2, 0.4].map((delay, i) => (
            <div
              key={i}
              className="w-1.25 h-1.25 rounded-full bg-[#C8A2C8] animate-pulse"
              style={{
